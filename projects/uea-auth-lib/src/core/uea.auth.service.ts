import { UeaAuthConfigService } from './uea.auth.config.service';
...
export class AuthService {
  ...
  private identityClaimsSubject$ = new BehaviorSubject<Object>({});
  public identityClaims$ = this.identityClaimsSubject$.asObservable();
  ...
  private navigateToLoginPage() {
    ...
    this.router.navigateByUrl(this.ueaAuthConfigService.getCBaseURI());
  }

  constructor(
    private oauthService: OAuthService,
    private router: Router,
    private ueaAuthConfigService: UeaAuthConfigService
  ) {
    const uaconfig = this.ueaAuthConfigService.getConfig();
    this.oauthService.configure(uaconfig);
