...
import { WX_URLS } from '../url-params.const';

@Injectable()
export class XXXWxServiceService {
  ...
  queryAdministrativeData(params: any, func: Function) {
    this.api
      .post(WX_URLS.queryAdministrativeData, params)
      .subscribe(result => func(result));
  }
...
//
//             接口整理
// 1、/svs/vacc/vr/queryAdminVaccinateRecord 接种记录 接口    managePovCode 怎么获取
