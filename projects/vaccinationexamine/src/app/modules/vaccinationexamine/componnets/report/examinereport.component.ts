...
@Component({
  selector: 'uea-examinereport-component',
  templateUrl: './examinereport.component.html',
  styleUrls: ['./examinereport.component.scss']
})
export class ExamineReportComponent implements OnInit, OnDestroy {

  nodes: any = SelectSchoolComponent.sampleNodes;
  detailTitle: string = '安徽省托幼机构（学校）查验预防接种证工作情况汇总表';
