...
@Component({
  selector: 'uea-business-volume',
  templateUrl: './business-volume.component.html',
  styleUrls: ['./business-volume.component.scss']
})
/**
 * 统计实时业务量
 */
export class BusinessVolumeComponent implements OnInit {
  ...
  queryData() {
    ...
    console.log('查询实时业务量', query);
    this.bsApi.queryVaccBusinessVolume(query, res => {
      console.log('实时业务量返回值', res);
      if (res.code === 0) {
