...
import {VacStockApprovalApiService, DateUtils} from '@tod/svs-common-lib';
import {Router} from '@angular/router';
import {UserService} from '../../../../../../../uea-auth-lib/src/core/user.service';
import {NzModalService} from 'ng-zorro-antd';

@Component({
  selector: 'uea-out-approval',
  templateUrl: './out-approval.component.html',
  styleUrls: ['./out-approval.component.scss'],
})
export class OutApprovalComponent implements OnInit {
  ...
  checkDetail(data: any): void {
    this.router.navigate(['/modules/stockapproval/vacorderdetailapproval'], {queryParams: data});
  }
