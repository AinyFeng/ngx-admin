...
@Component({
  selector: 'uea-type-two-monthly-audit',
  templateUrl: './type-two-monthly-audit.component.html',
  styleUrls: ['./type-two-monthly-audit.component.scss']
})
export class TypeTwoMonthlyAuditComponent implements OnInit {
  ...
  auditPlan(planMonthCode) {
    this.isSHow = true;
    this.tabIndex = 1;
    this.planMonthCode = planMonthCode;
  }
