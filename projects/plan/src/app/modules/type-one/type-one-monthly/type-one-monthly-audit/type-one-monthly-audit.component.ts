...
@Component({
  selector: 'uea-type-one-monthly-audit',
  templateUrl: './type-one-monthly-audit.component.html',
  styleUrls: ['./type-one-monthly-audit.component.scss']
})
export class TypeOneMonthlyAuditComponent implements OnInit {
