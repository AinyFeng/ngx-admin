...
import {
  ...
  VaccBroadHeadingDataService, TreeDataApi
} from '@tod/svs-common-lib';
import {UserService} from '@tod/uea-auth-lib';

@Component({
  selector: 'uea-rabies-vac-record',
  templateUrl: './rabies-vac-record.component.html',
  styleUrls: ['./rabies-vac-record.component.scss']
})
export class RabiesVacRecordComponent implements OnInit {
