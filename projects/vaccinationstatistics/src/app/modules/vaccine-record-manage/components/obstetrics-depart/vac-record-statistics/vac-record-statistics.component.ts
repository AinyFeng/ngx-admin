...
@Component({
  selector: 'uea-vac-record-statistics',
  templateUrl: './vac-record-statistics.component.html',
  styleUrls: ['./vac-record-statistics.component.scss']
})
export class VacRecordStatisticsComponent implements OnInit {
